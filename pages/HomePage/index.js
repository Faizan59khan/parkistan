...
const HomePage=({navigation}) =>{
  ...
  return (<View style={styles.container}>
     ...
     <Text style={styles.topHeading}>Hi Maham, Welcome To Parkistan </Text>
     ...
     <Image style={styles.gif} source={require ('./../../assets/car.gif')}/>
     </View>
     ...
     <View>
     <View style={styles.icons}>
     <Image style={styles.gif} source={require ('./../../assets/smartphone.gif')}/>
     </View>
     ...
     <View>
     <View style={styles.icons}>
     <Image style={styles.gif} source={require ('./../../assets/clock.gif')}/>
     </View>
     ...
     <View>
     <View style={styles.icons}>
     <Image style={styles.gif} source={require ('./../../assets/shield.gif')}/>
     </View>
     ...
     <View>
     <View style={styles.icons}>
     <Image style={styles.gif} source={require ('./../../assets/search.gif')}/>
     </View>
     ...
     <View>
     <View style={styles.icons}>
     <Image style={styles.gif} source={require ('./../../assets/home.gif')}/>
     </View>
    ...
    flexWrap:'wrap'}}>
     ...
     <Text style={styles.middleText}>Where are you going?</Text>
      ...
      <View style={{height:68,width:0,  borderWidth:1, borderRadius:50,
        borderColor:'rgba(139, 185, 141, 0.8)',marginLeft:5}}></View>
    ...
    placeholderTextColor="#033205"></TextInput>
    <FontAwesome 
                    name="search"
                    size={15}
                    color="#808080"
     ...
     <View style={styles.QuickParkHeading}>
      <Text onPress={()=>navigation.navigate('Map')} style={styles.QpText}>Search Parking Spot</Text>
     </View>
     </View>
     </View>
